  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
          ...
          <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus, maiores voluptate expedita id, culpa veniam at impedit fuga laboriosam quibusdam rem quidem saepe voluptas cumque sapiente ipsa. Pariatur, dignissimos quae.</p>
          {/* stats */}
